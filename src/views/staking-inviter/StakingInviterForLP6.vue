...
import {
  ...
  DSTAddress,
  ZeroAddress,
  StakingInviterForLPTokenAddress6,
  StakingInviterForLPContractAddress6,
  ...
  methods: {
    ...
    async getRelationship() {
      ...
      const inviter = await contract.methods
        ...
        .call({ from: StakingInviterForLPContractAddress6 });
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingInviterForLPContractAddress6)
        .call();
