...
import {
  DAOAddress,
  DSTAddress,
  StakingInviterForSingleTokenAddress4,
  StakingInviterForSingleContractAddress4
} from "@/constants";
  ...
  methods: {
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingInviterForSingleContractAddress4)
        .call();
    ...
    // 跳转历史记录
    gotoHistory() {
      this.$router.push({ path: "/staking/single/4/history" });
    }
  }
};
</script>
