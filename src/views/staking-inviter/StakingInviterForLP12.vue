...
import {
  ...
  DSTAddress,
  ZeroAddress,
  StakingInviterForLPTokenAddress12,
  StakingInviterForLPContractAddress12,
  ...
  methods: {
    ...
    async getRelationship() {
      ...
      const inviter = await contract.methods
        ...
        .call({ from: StakingInviterForLPContractAddress12 });
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingInviterForLPContractAddress12)
        .call();
    ...
    // 跳转历史记录
    gotoHistory() {
      this.$router.push({ path: "/staking/lp/12/history" });
    }
  }
};
</script>
