...
import {
  ...
  DSTAddress,
  ZeroAddress,
  StakingInviterForLPTokenAddress14,
  StakingInviterForLPContractAddress14,
  ...
  methods: {
    ...
    async getRelationship() {
      ...
      const inviter = await contract.methods
        ...
        .call({ from: StakingInviterForLPContractAddress14 });
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingInviterForLPContractAddress14)
        .call();
    ...
    // 跳转历史记录
    gotoHistory() {
      this.$router.push({ path: "/staking/lp/14/history" });
    }
  }
};
</script>
