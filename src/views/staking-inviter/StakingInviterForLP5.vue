...
import {
  ...
  DSTAddress,
  ZeroAddress,
  StakingInviterForLPTokenAddress5,
  StakingInviterForLPContractAddress5,
  ...
  methods: {
    ...
    async getRelationship() {
      ...
      const inviter = await contract.methods
        ...
        .call({ from: StakingInviterForLPContractAddress5 });
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingInviterForLPContractAddress5)
        .call();
