...
import {
  DAOAddress,
  DSTAddress,
  StakingInviterForSingleTokenAddress5,
  StakingInviterForSingleContractAddress5
} from "@/constants";
  ...
  methods: {
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingInviterForSingleContractAddress5)
        .call();
    ...
    // 跳转历史记录
    gotoHistory() {
      this.$router.push({ path: "/staking/single/5/history" });
    }
  }
};
</script>
