...
import {
  ...
  DSTAddress,
  ZeroAddress,
  StakingInviterForLPTokenAddress13,
  StakingInviterForLPContractAddress13,
  ...
  methods: {
    ...
    async getRelationship() {
      ...
      const inviter = await contract.methods
        ...
        .call({ from: StakingInviterForLPContractAddress13 });
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingInviterForLPContractAddress13)
        .call();
    ...
    // 跳转历史记录
    gotoHistory() {
      this.$router.push({ path: "/staking/lp/13/history" });
    }
  }
};
</script>
